  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="名字" prop="name">
        <el-input v-model="queryParams.name" placeholder="请输入艺人名字" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="艺名" prop="nickName">
        <el-input v-model="queryParams.nickName" placeholder="请输入艺人艺名" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="身份证号" prop="idCard">
        <el-input v-model="queryParams.idCard" placeholder="请输入身份证号" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="籍贯" prop="hometown">
        <el-input v-model="queryParams.hometown" placeholder="请输入籍贯" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['system:artist:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['system:artist:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['system:artist:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['system:artist:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="artistList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="标签" align="center" prop="labs">
        <template slot-scope="scope">
          <el-tag size="mini" v-for="tag in labs" :key="tag.var" :type="tag.type">
            {{ tag.var }}
          </el-tag>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="名字" prop="name">
          <el-input v-model="form.name" placeholder="请输入艺人名字" />
        </el-form-item>
        <el-form-item label="艺名" prop="nickName">
          <el-input v-model="form.nickName" placeholder="请输入艺人艺名" />
        </el-form-item>
        <el-form-item label="标签" prop="labs">
          <el-select v-model="form.labs" filterable clearable multiple placeholder="请选择艺人标签">
            <el-option-group v-for="group in labOptions" :key="group.label" :label="group.label">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除艺人管理编号为"' + ids + '"的数据项？').then(function () {
        return delArtist(ids);
      }).then(() => {
        this.getList();
